...
class OAuth2Client
{
     ...
     */
    final const BASE_AUTHORIZATION_URL = 'https://www.facebook.com';
     ...
     */
    public function __construct(protected FacebookApp $app, protected FacebookClient $client, $graphVersion = null)
    {
