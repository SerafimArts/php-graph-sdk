...
class GraphNodeFactory
{
     ...
     */
    public function __construct(protected FacebookResponse $response)
    {
     ...
     * @throws FacebookSDKException
     */
    public function castAsGraphNodeOrGraphEdge(array $data, $subclassName = null, $parentKey = null, $parentNodeId = null): \Facebook\GraphNodes\GraphEdge|\Facebook\GraphNodes\GraphNode
    {
        if (isset($data['data'])) {
            // Create GraphEdge
