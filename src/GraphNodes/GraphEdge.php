...
class GraphEdge extends Collection
{
     ...
     */
    public function __construct(protected FacebookRequest $request, array $data = [], protected array $metaData = [], protected ?string $parentEdgeEndpoint = null, protected ?string $subclassName = null)
    {
